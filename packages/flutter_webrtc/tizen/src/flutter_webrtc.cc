...
void FlutterWebRTC::HandleMethodCall(
  ...
  if (method_call.method_name().compare("createPeerConnection") == 0) {
    ...
    // const EncodableMap params =
    //     GetValue<EncodableMap>(*method_call.arguments());
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const EncodableMap constraints = findMap(params,
    // "constraints"); RTCPeerConnection* pc =
    // PeerConnectionForId(peerConnectionId); if (pc == nullptr) {
    ...
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const EncodableMap constraints = findMap(params,
    // "description"); RTCPeerConnection* pc =
    // PeerConnectionForId(peerConnectionId); if (pc == nullptr) {
    ...
    //     RTCSessionDescription::Create(findString(constraints,
    //     "type").c_str(),
    ...
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const EncodableMap constraints = findMap(params,
    // "candidate"); RTCPeerConnection* pc =
    // PeerConnectionForId(peerConnectionId); if (pc == nullptr) {
    ...
    //                             findInt(constraints, "sdpMLineIndex"),
    //                             &error);
    ...
    //     GetValue<EncodableMap>(*method_call.arguments());
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); RTCPeerConnection* pc =
    // PeerConnectionForId(peerConnectionId); if (pc == nullptr) {
    ...
    //   "mediaStreamTrackSetEnable() track is null"); return;
    // }
    ...
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const std::string trackId = findString(params,
    // "trackId"); const EncodableList streamIds = findList(params,
    // "streamIds");
    ...
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const std::string senderId = findString(params,
    // "senderId");
    ...
    //     GetValue<EncodableMap>(*method_call.arguments());
    // const std::string peerConnectionId = findString(params,
    // "peerConnectionId"); const EncodableMap transceiverInit = findMap(params,
    // "transceiverInit"); const std::string mediaType = findString(params,
    // "mediaType"); const std::string trackId = findString(params, "trackId");
    ...
    //   return;
    // }
    // AddTransceiver(pc, trackId, mediaType, transceiverInit,
    // std::move(result));
    ...
    // if (nullptr == track) {
    //   result->Error("rtpSenderSetTrack", "rtpSenderSetTrack() track is
    //   null"); return;
    // }
    ...
    //   if (pc == nullptr) {
    //     result->Error("rtpSenderReplaceTrack",
    //                   "rtpSenderReplaceTrack() rtpSenderId is null or
    //                   empty");
    //     return;
    //   }
    // }
    ...
    //   if (pc == nullptr) {
    //     result->Error("rtpSenderSetParameters",
    //                   "rtpSenderSetParameters() rtpSenderId is null or
    //                   empty");
    //     return;
    //   }
    // }
    ...
    // const std::string rtpTransceiverId = findString(params,
    // "rtpTransceiverId"); if (0 < rtpTransceiverId.size()) {
    //   if (pc == nullptr) {
    //     result->Error("rtpTransceiverStop",
    //                   "rtpTransceiverStop() rtpTransceiverId is null or
    //                   empty");
    //     return;
    //   }
    // }
    ...
    //                   "rtpTransceiverGetCurrentDirection() rtpTransceiverId
    //                   is " "null or empty");
    //     return;
    //   }
    // }

    // RtpTransceiverGetCurrentDirection(pc, rtpTransceiverId,
    // std::move(result));
    ...
    //     result->Error(
    //         "rtpTransceiverGetCurrentDirection",
    //         "rtpTransceiverGetCurrentDirection() direction is null or
    //         empty");
    //     return;
    //   }
    // }
    ...
    //   result->Error("captureFrame", "captureFrame() track not is video
    //   track"); return;
    // }
